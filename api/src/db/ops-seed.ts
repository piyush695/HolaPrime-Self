...
async function seedOps() {
  ...
  // 1. Country Controls — all world countries
  await q(`
    INSERT INTO country_controls (country_code, country_name, registration, payouts, risk_tier) VALUES
      ...
      ('AL','Albania',true,true,'standard'),
      ('DZ','Algeria',true,true,'standard'),
      ('AD','Andorra',true,true,'standard'),
      ('AO','Angola',true,true,'enhanced'),
      ('AG','Antigua and Barbuda',true,true,'standard'),
      ('AR','Argentina',true,true,'standard'),
      ('AM','Armenia',true,true,'standard'),
      ('AU','Australia',true,true,'standard'),
      ('AT','Austria',true,true,'standard'),
      ('AZ','Azerbaijan',true,true,'enhanced'),
      -- B
      ('BS','Bahamas',true,true,'standard'),
      ('BH','Bahrain',true,true,'standard'),
      ('BD','Bangladesh',true,true,'enhanced'),
      ('BB','Barbados',true,true,'standard'),
      ('BY','Belarus',false,false,'restricted'),
      ('BE','Belgium',true,true,'standard'),
      ('BZ','Belize',true,true,'standard'),
      ('BJ','Benin',true,true,'enhanced'),
      ('BT','Bhutan',true,true,'standard'),
      ('BO','Bolivia',true,true,'standard'),
      ('BA','Bosnia and Herzegovina',true,true,'standard'),
      ('BW','Botswana',true,true,'standard'),
      ('BR','Brazil',true,true,'standard'),
      ('BN','Brunei',true,true,'standard'),
      ('BG','Bulgaria',true,true,'standard'),
      ('BF','Burkina Faso',true,true,'enhanced'),
      ('BI','Burundi',true,false,'enhanced'),
      -- C
      ('CV','Cabo Verde',true,true,'standard'),
      ('KH','Cambodia',true,true,'enhanced'),
      ('CM','Cameroon',true,true,'enhanced'),
      ('CA','Canada',true,true,'standard'),
      ('CF','Central African Republic',true,false,'enhanced'),
      ('TD','Chad',true,true,'enhanced'),
      ('CL','Chile',true,true,'standard'),
      ('CN','China',false,false,'restricted'),
      ('CO','Colombia',true,true,'standard'),
      ('KM','Comoros',true,true,'enhanced'),
      ('CG','Congo',true,true,'enhanced'),
      ('CD','Congo (DRC)',true,true,'enhanced'),
      ('CR','Costa Rica',true,true,'standard'),
      ('HR','Croatia',true,true,'standard'),
      ('CU','Cuba',false,false,'restricted'),
      ('CY','Cyprus',true,true,'standard'),
      ('CZ','Czech Republic',true,true,'standard'),
      -- D
      ('DK','Denmark',true,true,'standard'),
      ('DJ','Djibouti',true,true,'enhanced'),
      ('DM','Dominica',true,true,'standard'),
      ('DO','Dominican Republic',true,true,'standard'),
      -- E
      ('EC','Ecuador',true,true,'standard'),
      ('EG','Egypt',true,true,'standard'),
      ('SV','El Salvador',true,true,'standard'),
      ('GQ','Equatorial Guinea',true,true,'enhanced'),
      ('ER','Eritrea',true,false,'enhanced'),
      ('EE','Estonia',true,true,'standard'),
      ('SZ','Eswatini',true,true,'enhanced'),
      ('ET','Ethiopia',true,true,'enhanced'),
      -- F
      ('FJ','Fiji',true,true,'standard'),
      ('FI','Finland',true,true,'standard'),
      ('FR','France',true,true,'standard'),
      -- G
      ('GA','Gabon',true,true,'enhanced'),
      ('GM','Gambia',true,true,'enhanced'),
      ('GE','Georgia',true,true,'standard'),
      ('DE','Germany',true,true,'standard'),
      ('GH','Ghana',true,true,'standard'),
      ('GR','Greece',true,true,'standard'),
      ('GD','Grenada',true,true,'standard'),
      ('GT','Guatemala',true,true,'standard'),
      ('GN','Guinea',true,true,'enhanced'),
      ('GW','Guinea-Bissau',true,true,'enhanced'),
      ('GY','Guyana',true,true,'standard'),
      -- H
      ('HT','Haiti',true,true,'enhanced'),
      ('HN','Honduras',true,true,'standard'),
      ('HU','Hungary',true,true,'standard'),
      -- I
      ('IS','Iceland',true,true,'standard'),
      ('IN','India',true,true,'standard'),
      ('ID','Indonesia',true,true,'standard'),
      ('IR','Iran',false,false,'restricted'),
      ('IQ','Iraq',true,true,'enhanced'),
      ('IE','Ireland',true,true,'standard'),
      ('IL','Israel',true,true,'standard'),
      ('IT','Italy',true,true,'standard'),
      ('CI','Ivory Coast',true,true,'enhanced'),
      -- J
      ('JM','Jamaica',true,true,'standard'),
      ('JP','Japan',true,true,'standard'),
      ('JO','Jordan',true,true,'standard'),
      -- K
      ('KZ','Kazakhstan',true,true,'enhanced'),
      ('KE','Kenya',true,true,'standard'),
      ('KI','Kiribati',true,true,'standard'),
      ('KW','Kuwait',true,true,'standard'),
      ('KG','Kyrgyzstan',true,true,'enhanced'),
      -- L
      ('LA','Laos',true,true,'enhanced'),
      ('LV','Latvia',true,true,'standard'),
      ('LB','Lebanon',true,true,'enhanced'),
      ('LS','Lesotho',true,true,'enhanced'),
      ('LR','Liberia',true,true,'enhanced'),
      ('LY','Libya',false,false,'restricted'),
      ('LI','Liechtenstein',true,true,'standard'),
      ('LT','Lithuania',true,true,'standard'),
      ('LU','Luxembourg',true,true,'standard'),
      -- M
      ('MG','Madagascar',true,true,'enhanced'),
      ('MW','Malawi',true,true,'enhanced'),
      ('MY','Malaysia',true,true,'standard'),
      ('MV','Maldives',true,true,'standard'),
      ('ML','Mali',true,true,'enhanced'),
      ('MT','Malta',true,true,'standard'),
      ('MH','Marshall Islands',true,true,'standard'),
      ('MR','Mauritania',true,true,'enhanced'),
      ('MU','Mauritius',true,true,'standard'),
      ('MX','Mexico',true,true,'standard'),
      ('FM','Micronesia',true,true,'standard'),
      ('MD','Moldova',true,true,'standard'),
      ('MC','Monaco',true,true,'standard'),
      ('MN','Mongolia',true,true,'standard'),
      ('ME','Montenegro',true,true,'standard'),
      ('MA','Morocco',true,true,'standard'),
      ('MZ','Mozambique',true,true,'enhanced'),
      ('MM','Myanmar',false,false,'restricted'),
      -- N
      ('NA','Namibia',true,true,'standard'),
      ('NR','Nauru',true,true,'standard'),
      ('NP','Nepal',true,true,'standard'),
      ('NL','Netherlands',true,true,'standard'),
      ('NZ','New Zealand',true,true,'standard'),
      ('NI','Nicaragua',true,true,'standard'),
      ('NE','Niger',true,true,'enhanced'),
      ('NG','Nigeria',true,true,'enhanced'),
      ('MK','North Macedonia',true,true,'standard'),
      ...
      ('PW','Palau',true,true,'standard'),
      ('PA','Panama',true,true,'standard'),
      ('PG','Papua New Guinea',true,true,'enhanced'),
      ('PY','Paraguay',true,true,'standard'),
      ('PE','Peru',true,true,'standard'),
      ...
      ('RW','Rwanda',true,true,'enhanced'),
      -- S
      ('KN','Saint Kitts and Nevis',true,true,'standard'),
      ('LC','Saint Lucia',true,true,'standard'),
      ('VC','Saint Vincent and the Grenadines',true,true,'standard'),
      ('WS','Samoa',true,true,'standard'),
      ('SM','San Marino',true,true,'standard'),
      ('ST','Sao Tome and Principe',true,true,'enhanced'),
      ('SA','Saudi Arabia',true,true,'standard'),
      ('SN','Senegal',true,true,'enhanced'),
      ('RS','Serbia',true,true,'standard'),
      ('SC','Seychelles',true,true,'standard'),
      ('SL','Sierra Leone',true,true,'enhanced'),
      ('SG','Singapore',true,true,'standard'),
      ('SK','Slovakia',true,true,'standard'),
      ('SI','Slovenia',true,true,'standard'),
      ('SB','Solomon Islands',true,true,'standard'),
      ('SO','Somalia',true,false,'enhanced'),
      ('ZA','South Africa',true,true,'standard'),
      ('SS','South Sudan',true,false,'enhanced'),
      ('ES','Spain',true,true,'standard'),
      ('LK','Sri Lanka',true,true,'standard'),
      ('SD','Sudan',false,false,'restricted'),
      ('SR','Suriname',true,true,'standard'),
      ('SE','Sweden',true,true,'standard'),
      ('CH','Switzerland',true,true,'standard'),
      ('SY','Syria',false,false,'restricted'),
      -- T
      ('TW','Taiwan',true,true,'standard'),
      ('TJ','Tajikistan',true,true,'enhanced'),
      ('TZ','Tanzania',true,true,'standard'),
      ('TH','Thailand',true,true,'standard'),
      ('TL','Timor-Leste',true,true,'enhanced'),
      ('TG','Togo',true,true,'enhanced'),
      ('TO','Tonga',true,true,'standard'),
      ('TT','Trinidad and Tobago',true,true,'standard'),
      ('TN','Tunisia',true,true,'standard'),
      ('TR','Turkey',true,true,'standard'),
      ('TM','Turkmenistan',true,true,'enhanced'),
      ('TV','Tuvalu',true,true,'standard'),
      -- U
      ...
      ('UY','Uruguay',true,true,'standard'),
      ('UZ','Uzbekistan',true,true,'enhanced'),
      -- V
      ('VU','Vanuatu',true,true,'standard'),
      ('VE','Venezuela',true,false,'enhanced'),
      ('VN','Vietnam',true,true,'standard'),
      -- Y
      ('YE','Yemen',true,false,'enhanced'),
      -- Z
      ('ZM','Zambia',true,true,'enhanced'),
      ('ZW','Zimbabwe',true,true,'enhanced')
  ...
  `);
  console.log('✅ Country Controls: 195 countries seeded');
  ...
  await q(`
    INSERT INTO site_content (key, label, description, value, content_type) VALUES
      ...
      ('company_name','Company Name','Legal company name','"Hola Prime"','text'),
